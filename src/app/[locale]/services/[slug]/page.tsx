    ...
    <>
      ...
      <main className="bg-cream-50 pt-16">
        ...
        <section className="relative h-[70vh] md:h-[85vh] w-full overflow-hidden bg-charcoal-900 group">
          ...
          <div className="absolute inset-0 flex flex-col justify-end pb-16 md:pb-24 pt-32 container mx-auto px-6 z-10 transition-all">
            <AnimatedSection>
              <Link
                href="/services"
                className="inline-flex items-center gap-3 text-warm-300 hover:text-brand-blue transition-colors uppercase tracking-[0.2em] text-[10px] md:text-xs font-mono mb-8 group/back border-b border-transparent hover:border-brand-blue pb-1 w-fit"
              >
                <ArrowLeft
                  size={14}
              ...
              <div className="mt-8 w-16 h-[3px] bg-brand-blue" />
            </AnimatedSection>
          </div>
        </section>
        ...
        <section className="bg-charcoal-800 border-y border-brand-blue/20 text-white relative z-20">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-brand-blue/20 font-mono tracking-widest uppercase text-xs">
              <div className="py-8 md:px-8 flex flex-col gap-2 justify-center hover:bg-white/5 transition-colors">
                <span className="text-brand-blue/60 text-[10px]">
                  {getT("timeline")}
                </span>
              ...
              <div className="py-8 md:px-8 flex flex-col gap-2 justify-center hover:bg-white/5 transition-colors">
                ...
                <span className="text-white font-mono font-medium text-sm tracking-wide">{getT("ideal_val")}</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="container mx-auto py-12 md:py-24 lg:py-40 px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
            {/* Left: Description (Editorial Style) */}
            <div className="lg:col-span-7 xl:col-span-8">
              <AnimatedSection>
                <span className="text-brand-blue font-mono text-xs tracking-[0.3em] uppercase mb-8 block">Full Description</span>
                <div className="prose prose-stone prose-base md:prose-lg max-w-none text-charcoal-700 leading-relaxed font-light whitespace-pre-line md:first-letter:text-5xl lg:first-letter:text-7xl md:first-letter:font-display md:first-letter:text-charcoal-900 md:first-letter:float-left md:first-letter:mr-4 lg:first-letter:mr-6 md:first-letter:-mt-2 md:first-letter:leading-none">
            ...
            <div className="lg:col-span-5 xl:col-span-4 mt-12 lg:mt-0">
              <div className="lg:sticky lg:top-32 bg-white p-8 md:p-12 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-warm-100 border-t-4 border-t-brand-blue">
                  ...
                  {rawDeliverables && rawDeliverables.length > 0 ? (
                    <ul className="space-y-8">
                      {rawDeliverables.map((item: string, index: number) => (
                        ...
                        >
                          <div className="font-mono text-brand-blue text-sm tracking-widest pt-1 group-hover:text-brand-blue-dark transition-colors">
                            0{index + 1}
                          </div>
        ...
        <section className="bg-charcoal-900 text-white py-16 md:py-32 border-t border-brand-blue/20">
          <div className="container mx-auto px-6 max-w-5xl">
            <AnimatedSection className="text-center mb-12 md:mb-24">
              <span className="font-mono text-xs tracking-[0.3em] uppercase text-brand-blue/80 mb-4 md:mb-6 block">
                {t("execution")}
              </span>
            ...
            <div className="space-y-0 text-left relative before:absolute before:inset-0 before:ml-auto before:mr-auto md:before:ml-[28px] before:-translate-x-px md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-brand-blue/40 before:to-transparent">
              {[0, 1, 2].map((i) => {
                ...
                return (
                  ...
                  >
                    <div className="hidden md:flex flex-shrink-0 w-14 h-14 rounded-full bg-charcoal-900 border-2 border-brand-blue/30 group-hover:border-brand-blue transition-colors duration-500 items-center justify-center z-10 text-brand-blue/60 group-hover:text-brand-blue font-mono">
                      0{i + 1}
                    </div>
                    <div className="md:w-full bg-charcoal-800/30 border border-brand-blue/10 hover:border-brand-blue/30 p-6 md:p-12 hover:bg-charcoal-800/80 transition-colors duration-500 w-full relative z-10 backdrop-blur-sm">
                      <span className="font-mono text-[10px] tracking-widest text-brand-blue/70 uppercase mb-4 block">
                        {phase}
                      </span>
        ...
        {featuredProjects && featuredProjects.length > 0 && (
          <section className="bg-cream-100 py-16 md:py-32 border-t-[3px] border-brand-blue">
            <div className="container mx-auto px-6 max-w-7xl">
              <AnimatedSection className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
                <div>
                  <span className="font-mono text-xs tracking-[0.3em] uppercase text-brand-blue mb-4 block">
                    {t("proof")}
                  </span>
                ...
                <Link
                  href="/portfolio"
                  className="inline-flex items-center gap-3 text-brand-blue border-b border-brand-blue pb-1 font-mono text-xs uppercase tracking-widest hover:text-brand-blue-dark hover:border-brand-blue-dark transition-all"
                >
                  ...
                  >
                    <Link href={`/portfolio/${project.slug}`}>
                      <div className="relative aspect-[4/5] md:aspect-[3/4] overflow-hidden mb-8">
                        ...
                        />
                        <div className="absolute inset-0 bg-charcoal-900/5 group-hover:bg-brand-blue/8 transition-colors duration-700" />
                      </div>
                      <h3 className="text-2xl font-display text-charcoal-900 mb-2 group-hover:text-brand-blue transition-colors">
                        {project.title}
                      </h3>
                      <p className="text-brand-blue font-mono text-xs uppercase tracking-widest">
          ...
          <section className="bg-white py-24 border-t border-warm-200 px-6">
            <div className="container mx-auto max-w-7xl">
              <AnimatedSection className="mb-12 text-center">
                ...
                <p className="text-brand-blue font-mono text-xs uppercase tracking-[0.3em]">
                  {t("gallery_sub")}
                </p>
              </AnimatedSection>
        ...
        <section className="bg-cream-50 py-14 md:py-32 px-6 border-t border-warm-200">
          <div className="container mx-auto max-w-4xl">
            <AnimatedSection className="mb-20 text-center">
              <h2 className="text-3xl md:text-5xl font-display text-charcoal-900 mb-4 md:mb-6">
                {t("faq_title")}
              </h2>
              <div className="w-16 h-px bg-brand-blue mx-auto" />
            </AnimatedSection>
              ...
              {[0, 1, 2].map((i) => {
                ...
                return (
                  <AnimatedSection key={i} delay={i * 100} className="border-b border-brand-blue/10 pb-12 mb-12 last:border-0 last:mb-0">
                    ...
                    <p className="text-base md:text-lg text-charcoal-600 font-light leading-relaxed">
                      {a}
                    </p>
                  </AnimatedSection>
                );
